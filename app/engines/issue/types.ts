import type { NormalizedLogEntry, PermissionPolicy, ProcessStatus, SpawnedProcess } from '../types'
...
export type StateChangeCallback = (issueId: string, executionId: string, state: ProcessStatus) => void
